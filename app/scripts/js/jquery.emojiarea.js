...
(function($, window, document) {
	...
	*/
    ...
    var blankGifPath = $.emojiarea.assetsPath + '/blank.gif';
		...
		var style = 'background:url(\'' + filename.replace('!', category) + '\') '
				+ xoffset + 'px ' + yoffset + 'px no-repeat;';

		return '<img src="' + blankGifPath + '" class="img x" style="'
    ...
    this.emojiPopup = options.emojiPopup;
		this.$editor = $('<div ng-model="emojiMessage">').addClass('emoji-wysiwyg-editor').addClass($($textarea)[0].className);
